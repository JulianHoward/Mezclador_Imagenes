...
public class PictureTwo extends Transformaciones {

    private BufferedImage foto= null;
    private final static Logger logger = (Logger) LogManager.getRootLogger();
    private int color;

    public PictureTwo(PictureObject foto) {
        imagenBase = foto;
    }
    ...
    public void hacer() {
        try {
            File imagen = new File("equipo2015.jpg");
            ...
            logger.debug("Se carga imagen #2 al 0%");
            ...
            logger.debug("Se carga imagen #2 al 50%");
